 ...
 */
export function phasedSine(ctx, phase = 0) {
 ...
 * @param {{depth?: number, rates?: number[], startAt?: number}} [opts]
 * @returns {{node: GainNode, dispose: () => void}} node — insert in the layer chain
 */
export function createOneOverF(ctx, opts = {}) {
