...
import { createVoicePool, getNoiseBuffer } from '../noise';
...
export function createThunder(ctx: BaseAudioContext, { scheduler, params = {}, key = 'thunder' }: LayerIO): Layer {
  ...
  function boom(t: number, peak: number, cutoff: number, attack: number, decay: number): void {
