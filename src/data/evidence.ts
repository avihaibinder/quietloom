...
export const EVIDENCE: Record<string, EvidenceEntry> = {
  ...
  moonrise: {
    ...
    badge: BADGE.EMERGING,
    claim:
      'A sheep crosses now and then. We never ask you to count it — counting is the folklore; imagery is the part that was actually tested.',
    detail:
...
export const BREATH_EVIDENCE: Record<string, EvidenceEntry> = {
  coherence: {
...
export const VOLUME_EVIDENCE: EvidenceEntry = {
