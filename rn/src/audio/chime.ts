 ...
 * possible to miss it.
 *
 * Every node is stopped and disconnected on `ended` (spelled `onEnded` in
...
export function playChime(ctx: BaseAudioContext, destination: AudioNode, { gain = 0.3 }: { gain?: number } = {}): void {
