...
import type { AudioNode, BaseAudioContext, OscillatorNode } from 'react-native-audio-api';
...
export function createCrickets(ctx: BaseAudioContext, { scheduler, key = 'crickets' }: LayerIO): Layer {
